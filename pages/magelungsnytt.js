...
export default function magelungsNytt(props) {
  ...
  let years = props.magelungsNytt.map(item => {
  ...
  return (
    ...
    <div>
      <div className='page-intro-text'>
        ...
        <span> kommer ungefär var tredje månad och innehåller nyheter kring allt möjligt som händer i föreningen. Vill du ta upp något som berör de boende i föreningen så kontakta styrelsen.
          </span>
      </div>
